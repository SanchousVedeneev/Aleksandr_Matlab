...
#define S_FUNCTION_NAME pwmModule_msf
#endif
...
) { kumy01kfnx4 * dw = ( kumy01kfnx4 * ) ssGetDWork ( S , 0 ) ; const real_T
* i_i_czspp4wwgn = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T
* i_bjbwdelfok = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T *
o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) {
pwmModule ( & ( dw -> rtm ) , i_i_czspp4wwgn , i_bjbwdelfok , o_B_1_1 , & (
...
mr_pwmModule_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 3 ) ;
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_pwmModule_MdlInfoRegFcn
( S , "pwmModule" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( kumy01kfnx4 ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { kumy01kfnx4 * dw = (
kumy01kfnx4 * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } phg1nlb4kn
...
* S , int_T tid ) { kumy01kfnx4 * dw = ( kumy01kfnx4 * ) ssGetDWork ( S , 0 )
; const real_T * i_i_czspp4wwgn = ( real_T * ) ssGetInputPortSignal ( S , 0 )
; const real_T * i_bjbwdelfok = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid ==
PARAMETER_TUNING_TID ) { pwmModuleTID2 ( & ( dw -> rtb ) ) ; } if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 ,
tid ) || ssIsMinorTimeStep ( S ) ) { pwmModule ( & ( dw -> rtm ) ,
i_i_czspp4wwgn , i_bjbwdelfok , o_B_1_1 , & ( dw -> rtb ) , & ( dw -> rtdw )
) ; } } }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { kumy01kfnx4 * dw = (
kumy01kfnx4 * ) ssGetDWork ( S , 0 ) ; const real_T * i_i_czspp4wwgn = (
real_T * ) ssGetInputPortSignal ( S , 0 ) ; lo11qnivjt * localZCSV = (
lo11qnivjt * ) ssGetNonsampledZCs ( S ) ; jiiolryi0a ( i_i_czspp4wwgn , & (
dw -> rtb ) , localZCSV ) ; } static void mdlTerminate ( SimStruct * S ) {
kumy01kfnx4 * dw = ( kumy01kfnx4 * ) ssGetDWork ( S , 0 ) ; jdbkzszijr ( & (
dw -> rtm ) ) ; return ; }
...
simStateFieldNames ) ; { mxArray * mdlrefDW = mr_pwmModule_GetDWork (
ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } {
mxArray * data = mr_pwmModule_GetSimStateDisallowedBlocks ( ) ;
...
mr_pwmModule_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 ,
