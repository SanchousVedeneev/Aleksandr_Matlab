...
#define S_FUNCTION_NAME Regulator_msf
#endif
...
br0gwccfleh * dw = ( br0gwccfleh * ) ssGetDWork ( S , 0 ) ; real_T *
o_o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_o_B_3_2
= ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; idsv0brghs ( o_o_B_3_1 ,
o_o_B_3_2 , & ( dw -> rtdw ) ) ; } static void mdlReset ( SimStruct * S ) {
br0gwccfleh * dw = ( br0gwccfleh * ) ssGetDWork ( S , 0 ) ; m2owyfvrk5 ( & (
dw -> rtdw ) ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S ,
int_T tid ) { br0gwccfleh * dw = ( br0gwccfleh * ) ssGetDWork ( S , 0 ) ;
const real_T * i_i2wfnqkjfb = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
const real_T * i_e4frj4aqgt = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
const real_T * i_ogxovm5xbk = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
const real_T * i_mhhfdo2dz0 = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ;
const real_T * i_jenkjg3ydo = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ;
const real_T * i_md4b1bz5tg = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ;
const real_T * i_lohy4psqzj = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ;
const real_T * i_i_ln1mih2byc = ( real_T * ) ssGetInputPortSignal ( S , 7 ) ;
real_T * o_o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T *
o_o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid == 0 ) {
Regulator ( & ( dw -> rtm ) , i_i2wfnqkjfb , i_e4frj4aqgt , i_ogxovm5xbk ,
i_mhhfdo2dz0 , i_jenkjg3ydo , i_md4b1bz5tg , i_lohy4psqzj , i_i_ln1mih2byc ,
o_o_B_3_1 , o_o_B_3_2 , & ( dw -> rtdw ) , & ( dw -> rtzce ) ) ; } } static
...
slmrInitializeIOPortDataVectors ( S , 8 , 2 ) ; if ( ! ssSetNumInputPorts ( S
...
( S , 7 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 2 ) ) return ; if ( !
...
mr_Regulator_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_Regulator_MdlInfoRegFcn
( S , "Regulator" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( br0gwccfleh ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { br0gwccfleh * dw = (
br0gwccfleh * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } m5ee4bufou
( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) ,
slmrGetTopTidFromMdlRefChildTid ( S , 1 , false ) , & ( dw -> rtm ) , & ( dw
-> rtdw ) , & ( dw -> rtzce ) , sysRanPtr , sysTid , ( NULL ) , ( NULL ) , 0
...
* S , int_T tid ) { br0gwccfleh * dw = ( br0gwccfleh * ) ssGetDWork ( S , 0 )
; const real_T * i_i2wfnqkjfb = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
const real_T * i_e4frj4aqgt = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
const real_T * i_ogxovm5xbk = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
const real_T * i_mhhfdo2dz0 = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ;
...
const real_T * i_i_ln1mih2byc = ( real_T * ) ssGetInputPortSignal ( S , 7 ) ;
real_T * o_o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T *
o_o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { Regulator ( & ( dw -> rtm ) ,
i_i2wfnqkjfb , i_e4frj4aqgt , i_ogxovm5xbk , i_mhhfdo2dz0 , i_jenkjg3ydo ,
i_md4b1bz5tg , i_lohy4psqzj , i_i_ln1mih2byc , o_o_B_3_1 , o_o_B_3_2 , & ( dw
-> rtdw ) , & ( dw -> rtzce ) ) ; } }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { br0gwccfleh * dw = (
br0gwccfleh * ) ssGetDWork ( S , 0 ) ; const real_T * i_i_ln1mih2byc = (
real_T * ) ssGetInputPortSignal ( S , 7 ) ; o2puchajdl * localZCSV = (
o2puchajdl * ) ssGetNonsampledZCs ( S ) ; a1kktpeqsn ( i_i_ln1mih2byc ,
localZCSV ) ; } static void mdlTerminate ( SimStruct * S ) { br0gwccfleh * dw
= ( br0gwccfleh * ) ssGetDWork ( S , 0 ) ; oore1qfowu ( & ( dw -> rtm ) ) ;
return ; }
...
simStateFieldNames ) ; { mxArray * mdlrefDW = mr_Regulator_GetDWork (
ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } {
mxArray * data = mr_Regulator_GetSimStateDisallowedBlocks ( ) ;
...
mr_Regulator_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 ,
