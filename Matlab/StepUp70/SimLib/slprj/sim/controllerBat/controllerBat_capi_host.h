...
#ifndef RTW_HEADER_controllerBat_cap_host_h_
#define RTW_HEADER_controllerBat_cap_host_h_
...
; pwmTriangle_host_DataMapInfo_T child9 ; } controllerBat_host_DataMapInfo_T
;
#ifdef __cplusplus
extern "C" {
#endif
