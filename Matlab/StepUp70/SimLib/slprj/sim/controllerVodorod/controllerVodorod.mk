...
MODEL                = controllerVodorod
MODULES              = controllerVodorod.c controllerVodorod_capi.c
MAKEFILE             = controllerVodorod.mk
...
MODELLIB                  = controllerVodorodlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = controllerVodorod_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/controllerVodorod \
