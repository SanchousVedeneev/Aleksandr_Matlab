...
real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T * i_n5hxrulw2q = (
...
, i_pblo3i3yif , i_n5hxrulw2q , i_ft4ggscqa0 , i_czu5rn3dfi , i_ltnha035q5 ,
...
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } bab4m2xfm1 ( S ,
...
i_n5hxrulw2q = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; const real_T *
