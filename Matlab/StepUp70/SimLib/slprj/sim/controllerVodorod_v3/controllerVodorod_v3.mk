...
MODEL                = controllerVodorod_v3
MODULES              = controllerVodorod_v3.c controllerVodorod_v3_capi.c
MAKEFILE             = controllerVodorod_v3.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = D:/Kechkin_doc/MatlabPro/VID/DC/StepUp70/SimLib
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 6
...
CLASSIC_INTERFACE    = 0
MODELREFS            = Regulator pwmModule pwmTriangle 
...
MODELLIB                  = controllerVodorod_v3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = controllerVodorod_v3_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/controllerVodorod_v3 \
