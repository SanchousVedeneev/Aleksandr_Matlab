...
MODEL                = Regulator
MODULES              = Regulator.c Regulator_capi.c
MAKEFILE             = Regulator.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = D:/Kechkin_doc/MatlabPro/VID/DC/StepUp70/Расчёт
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 0
...
MODELLIB                  = Regulatorlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Regulator_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/Regulator \
	-ID:/Kechkin_doc/MatlabPro/VID/DC/StepUp70/SimLib \
