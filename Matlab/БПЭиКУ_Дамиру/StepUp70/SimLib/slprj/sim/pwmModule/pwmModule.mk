...
MODEL                = pwmModule
MODULES              = pwmModule.c pwmModule_capi.c
MAKEFILE             = pwmModule.mk
...
MODELLIB                  = pwmModulelib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = pwmModule_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/pwmModule \
