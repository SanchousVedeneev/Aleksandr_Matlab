...
real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T * i_i0cx2vfqe0 = (
...
i_ct2hmk1cdx , i_i0cx2vfqe0 , i_bpo3ur03k1 , i_k1nd43wub0 , i_nrrt3g132p ,
...
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } hfhy5cdpmm ( S ,
...
i_i0cx2vfqe0 = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; const real_T *
