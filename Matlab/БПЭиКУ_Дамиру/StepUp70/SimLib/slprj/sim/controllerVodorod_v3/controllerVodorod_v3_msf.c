...
#define S_FUNCTION_NAME controllerVodorod_v3_msf
#endif
...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { lwkeiu4mt4o * dw = (
lwkeiu4mt4o * ) ssGetDWork ( S , 0 ) ; real_T * o_o_B_2_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; js3n4q55qd * localX = ( js3n4q55qd * )
ssGetContStates ( S ) ; hehbdv0jkc ( o_o_B_2_4 , & ( dw -> rtb ) , & ( dw ->
rtdw ) , localX ) ; } static void mdlReset ( SimStruct * S ) { lwkeiu4mt4o *
dw = ( lwkeiu4mt4o * ) ssGetDWork ( S , 0 ) ; js3n4q55qd * localX = (
js3n4q55qd * ) ssGetContStates ( S ) ; a1zuxcbpf4 ( & ( dw -> rtdw ) , localX
) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) {
lwkeiu4mt4o * dw = ( lwkeiu4mt4o * ) ssGetDWork ( S , 0 ) ; const real_T *
i_cf40uhfxtw = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T *
i_boklkelnl0 = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; const real_T *
i_ohjfebbnna = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; const real_T *
i_jiigabeu2h = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; const real_T *
i_n0zd1z1szv = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; const real_T *
i_po4rwgt0dn = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T * o_B_2_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_2_2 = ( real_T
* ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_2_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; real_T * o_o_B_2_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; js3n4q55qd * localX = ( js3n4q55qd * )
ssGetContStates ( S ) ; if ( tid == 0 ) { controllerVodorod_v3 ( & ( dw ->
rtm ) , i_cf40uhfxtw , i_boklkelnl0 , i_ohjfebbnna , i_jiigabeu2h ,
i_n0zd1z1szv , i_po4rwgt0dn , o_B_2_1 , o_B_2_2 , o_B_2_3 , o_o_B_2_4 , & (
dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; l11ckoolpj ( & ( dw -> rtm ) , &
...
mr_controllerVodorod_v3_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes
...
mr_controllerVodorod_v3_MdlInfoRegFcn ( S , "controllerVodorod_v3" , & retVal
) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( lwkeiu4mt4o ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { lwkeiu4mt4o * dw = (
lwkeiu4mt4o * ) ssGetDWork ( S , 0 ) ; js3n4q55qd * localX = ( js3n4q55qd * )
ssGetContStates ( S ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ;
ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , &
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } m1iqpdj14h ( S ,
...
-> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { lwkeiu4mt4o * dw = ( lwkeiu4mt4o * )
ssGetDWork ( S , 0 ) ; mdlProcessParameters ( S ) ; heyjo0abia ( & ( dw ->
...
controllerVodorod_v3TID2 ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } if ( tid
!= CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0
, tid ) || ssIsMinorTimeStep ( S ) ) { controllerVodorod_v3 ( & ( dw -> rtm )
, i_cf40uhfxtw , i_boklkelnl0 , i_ohjfebbnna , i_jiigabeu2h , i_n0zd1z1szv ,
i_po4rwgt0dn , o_B_2_1 , o_B_2_2 , o_B_2_3 , o_o_B_2_4 , & ( dw -> rtb ) , &
( dw -> rtdw ) , localX ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { lwkeiu4mt4o * dw = (
lwkeiu4mt4o * ) ssGetDWork ( S , 0 ) ; if ( ssIsSampleHit ( S , 0 , tid ) ) {
l11ckoolpj ( & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; }
return ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { lwkeiu4mt4o * dw = (
lwkeiu4mt4o * ) ssGetDWork ( S , 0 ) ; pt1naupvub * localZCSV = ( pt1naupvub
* ) ssGetNonsampledZCs ( S ) ; p235fwogck ( & ( dw -> rtb ) , & ( dw -> rtdw
) , localZCSV ) ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { lwkeiu4mt4o * dw = (
lwkeiu4mt4o * ) ssGetDWork ( S , 0 ) ; bqyzy0qlad * localXdot = ( bqyzy0qlad
* ) ssGetdX ( S ) ; iaovebmshm ( & ( dw -> rtdw ) , localXdot ) ; } static
void mdlTerminate ( SimStruct * S ) { lwkeiu4mt4o * dw = ( lwkeiu4mt4o * )
ssGetDWork ( S , 0 ) ; mg25sqmbc3 ( & ( dw -> rtdw ) , & ( dw -> rtm ) ) ;
return ; }
...
simStateFieldNames ) ; { const js3n4q55qd * localX = ( const js3n4q55qd * )
ssGetContStates ( S ) ; const size_t numBytes = sizeof ( js3n4q55qd ) ;
...
storedX ) ; } { mxArray * mdlrefDW = mr_controllerVodorod_v3_GetDWork (
ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } {
mxArray * data = mr_controllerVodorod_v3_GetSimStateDisallowedBlocks ( ) ;
...
js3n4q55qd * localX = ( js3n4q55qd * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( js3n4q55qd ) ; const mxArray * storedX =
mxGetFieldByNumber ( ss , 0 , 0 ) ; const UINT8_T * rawData = ( const UINT8_T
* ) mxGetData ( storedX ) ; memcpy ( localX , & rawData [ 0 ] , numBytes ) ;
} mr_controllerVodorod_v3_SetDWork ( ssGetDWork ( S , 0 ) ,
