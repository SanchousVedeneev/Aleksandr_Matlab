...
#define S_FUNCTION_NAME controllerBat_msf
#endif
...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { kgggvd1faq2 * dw = (
kgggvd1faq2 * ) ssGetDWork ( S , 0 ) ; jbeieohcqw * localX = ( jbeieohcqw * )
ssGetContStates ( S ) ; ctotqyrd0p ( & ( dw -> rtb ) , & ( dw -> rtdw ) ,
localX ) ; } static void mdlReset ( SimStruct * S ) { kgggvd1faq2 * dw = (
kgggvd1faq2 * ) ssGetDWork ( S , 0 ) ; jbeieohcqw * localX = ( jbeieohcqw * )
ssGetContStates ( S ) ; bnfjkdn4xn ( & ( dw -> rtdw ) , localX ) ; } static
void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { kgggvd1faq2 * dw
= ( kgggvd1faq2 * ) ssGetDWork ( S , 0 ) ; const real_T * i_ct2hmk1cdx = (
real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T * i_cwxrcioynr = (
real_T * ) ssGetInputPortSignal ( S , 1 ) ; const real_T * i_bpo3ur03k1 = (
real_T * ) ssGetInputPortSignal ( S , 2 ) ; const real_T * i_k1nd43wub0 = (
real_T * ) ssGetInputPortSignal ( S , 3 ) ; const real_T * i_nrrt3g132p = (
real_T * ) ssGetInputPortSignal ( S , 4 ) ; const real_T * i_ezp52oysp0 = (
...
ssGetOutputPortSignal ( S , 3 ) ; jbeieohcqw * localX = ( jbeieohcqw * )
ssGetContStates ( S ) ; if ( tid == 0 ) { controllerBat ( & ( dw -> rtm ) ,
i_ct2hmk1cdx , i_cwxrcioynr , i_bpo3ur03k1 , i_k1nd43wub0 , i_nrrt3g132p ,
i_ezp52oysp0 , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , & ( dw -> rtb ) , & (
dw -> rtdw ) , localX ) ; icaae0t0vb ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ;
...
7 , 4 ) ; if ( ! ssSetNumInputPorts ( S , 7 ) ) return ; if ( !
...
( S , 6 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 4 ) ) return ; if ( !
...
mr_controllerBat_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 3
...
mr_controllerBat_MdlInfoRegFcn ( S , "controllerBat" , & retVal ) ; if ( !
retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( kgggvd1faq2 ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { kgggvd1faq2 * dw = (
kgggvd1faq2 * ) ssGetDWork ( S , 0 ) ; jbeieohcqw * localX = ( jbeieohcqw * )
...
) ; mr_nonContOutputArray [ 3 ] = mr_nonContOutput3 ; hfhy5cdpmm ( S ,
...
#define MDL_START
static void mdlStart ( SimStruct * S ) { kgggvd1faq2 * dw = ( kgggvd1faq2 * )
ssGetDWork ( S , 0 ) ; mdlProcessParameters ( S ) ; n3bw3qo5jk ( & ( dw ->
rtdw ) ) ; } static void mdlOutputs ( SimStruct * S , int_T tid ) {
kgggvd1faq2 * dw = ( kgggvd1faq2 * ) ssGetDWork ( S , 0 ) ; const real_T *
i_ct2hmk1cdx = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T *
i_cwxrcioynr = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; const real_T *
i_bpo3ur03k1 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; const real_T *
i_k1nd43wub0 = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; const real_T *
i_nrrt3g132p = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; const real_T *
i_ezp52oysp0 = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T * o_B_1_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_1_2 = ( real_T
* ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_1_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; jbeieohcqw * localX = ( jbeieohcqw * )
ssGetContStates ( S ) ; if ( tid == PARAMETER_TUNING_TID ) {
controllerBatTID2 ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 ,
tid ) || ssIsMinorTimeStep ( S ) ) { controllerBat ( & ( dw -> rtm ) ,
i_ct2hmk1cdx , i_cwxrcioynr , i_bpo3ur03k1 , i_k1nd43wub0 , i_nrrt3g132p ,
i_ezp52oysp0 , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , & ( dw -> rtb ) , & (
dw -> rtdw ) , localX ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { kgggvd1faq2 * dw = (
kgggvd1faq2 * ) ssGetDWork ( S , 0 ) ; if ( ssIsSampleHit ( S , 0 , tid ) ) {
icaae0t0vb ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; } return ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { kgggvd1faq2 * dw = (
kgggvd1faq2 * ) ssGetDWork ( S , 0 ) ; pukm5my3sv * localZCSV = ( pukm5my3sv
* ) ssGetNonsampledZCs ( S ) ; obarucvacx ( & ( dw -> rtb ) , & ( dw -> rtdw
) , localZCSV ) ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { kgggvd1faq2 * dw = (
kgggvd1faq2 * ) ssGetDWork ( S , 0 ) ; jk4n3sowaa * localXdot = ( jk4n3sowaa
* ) ssGetdX ( S ) ; fhxu1bhy2n ( & ( dw -> rtdw ) , localXdot ) ; } static
void mdlTerminate ( SimStruct * S ) { kgggvd1faq2 * dw = ( kgggvd1faq2 * )
ssGetDWork ( S , 0 ) ; ljtbjh5abf ( & ( dw -> rtdw ) , & ( dw -> rtm ) ) ;
return ; }
...
simStateFieldNames ) ; { const jbeieohcqw * localX = ( const jbeieohcqw * )
ssGetContStates ( S ) ; const size_t numBytes = sizeof ( jbeieohcqw ) ;
...
storedX ) ; } { mxArray * mdlrefDW = mr_controllerBat_GetDWork ( ssGetDWork (
S , 0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data
= mr_controllerBat_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
jbeieohcqw * localX = ( jbeieohcqw * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( jbeieohcqw ) ; const mxArray * storedX =
mxGetFieldByNumber ( ss , 0 , 0 ) ; const UINT8_T * rawData = ( const UINT8_T
* ) mxGetData ( storedX ) ; memcpy ( localX , & rawData [ 0 ] , numBytes ) ;
} mr_controllerBat_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
